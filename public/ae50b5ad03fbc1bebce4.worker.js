...
/******/ 				importScripts(__webpack_require__.p + "" + chunkId + "." + "ae50b5ad03fbc1bebce4" + ".worker.js");
/******/ 			}
/******/ 		}));
...
module.exports = __webpack_require__.p + "bc3a26572093dc3d2eb3512f8226005e.wasm";
            ...
            wasmSupported = function () {
              try {
                if ((typeof WebAssembly === "undefined" ? "undefined" : typeof_default()(WebAssembly)) === 'object' && typeof WebAssembly.instantiate === 'function') {
                  ...
                  console.log('WebAssembly is not supported', e);
              }
              return false;
            }();
            if (!wasmSupported) {
